  ...
  return (
    <section className="max-padd-container flex gap-6 h-[634px] mt-16">
      ...
      >
        {/* LEFT SIDE */}
        <div
          className="max-padd-container flex flex-col h-full 
justify-center pt-8"
        >
          <h3
            className="bold-24 
  text-secondary font-thin
  "
          >
            Explore Books You'll Love
          </h3>
          <h1
            className="h1 max-w-[699px] !font-[800] 
  leading-none"
          >
            Find Your Next Book!
          </h1>
          ...
          <p className="max-w-xl pt-5">
            ...
            books. Whether you're searching for the latest bestsellers, timeless
  ...
  font-medium pl-6 rounded-full flexCenter gap-x-6 
  group "
            >
              Check our latest Stock
              <FaArrowRight
                className="bg-secondary text-white 
                rounded-full h-11 w-11 p-3 m-[3px] border
                border-white group-hover:bg-primary
      ...
      {/* RIGHT SIDE */}
      <div
        className="hidden lg:block flex-2 bg-primary
rounded-2xl bg-center bg-cover bg-no-repeat"
